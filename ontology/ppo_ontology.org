...
ppo:ArticlePublishingCharges a rdf:Class ;
    ...
    rdfs:comment "Article Processing Charges (APCs) are publication fees charged to authors of scholarly articles during the publication process."@en .
#+end_src
...
ppo:EvaluationPolicy rdfs:subClassOf ppo:Policy ;
    ...
    rdfs:comment "A collection of rules and allowances that a platform maintains during the evaluation of a scholarly article."@en .
#+end_src
...
ppo:PublicAccessability a rdfs:Class ;
    ...
    rdfs:comment "Object that describes the public accessability of an entity."@en .
#+end_src
...
ppo:PublicationPolicy rdfs:subClassOf ppo:Policy ;
    ...
    rdfs:comment "A collection of rules and allowances that a platform maintains during the publication of a scholarly article."@en .
#+end_src
...
ppo:hasArticlePublishingCharges a rdf:Property ;
    ...
    rdfs:comment "A relation linking publication policies to article publising charges."@en .
#+end_src
...
ppo:interactsWith a owl:SymmetricProperty ;
    ...
    rdfs:comment "Relation that signifies that the subject can interact with the object during the review process."@en .
#+end_src
...
ppo:involves a rdf:Property ;
    ...
    rdfs:comment "Relation that signifies that the object is involved during the process for a specific policy."@en .
#+end_src
...
ppo:publicationCondition a rdf:Property ;
    ...
    rdfs:comment "Relation describing a condition for allowing publication on other platforms."@en .
#+end_src
...
#+begin_src ttl
ppo:Accessible a ppo:PublicAccessability; a owl:NamedIndividual ;
...
#+begin_src ttl
ppo:NotAccessible a ppo:PublicAccessability; a owl:NamedIndividual ;
