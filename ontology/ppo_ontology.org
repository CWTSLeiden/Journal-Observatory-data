...
** ppo:PublicationPolicy                                                     :class:

#+begin_src ttl
ppo:PublicationPolicy rdfs:subClassOf ppo:Policy ;
    rdfs:label "Publication Policy"@en ;
    rdfs:comment "Rules and allowances that a platform maintains during the publication of a scholarly article."@en .
#+end_src
...
** ppo:documentVersion                                                       :class:

#+begin_src ttl
ppo:documentVersion a rdf:Class ;
    rdfs:label "Document version"@en ;
    rdfs:comment "The version of a publishable document."@en .
#+end_src

** ppo:publishedVersion                                                 :individual:

#+begin_src ttl
ppo:publishedVersion a ppo:documentVersion ;
    rdfs:label "Published version"@en ;
    rdfs:comment "The published version of a publishable document."@en .
#+end_src

** ppo:acceptedVersion                                                  :individual:

#+begin_src ttl
ppo:acceptedVersion a ppo:documentVersion ;
    rdfs:label "Accepted version"@en ;
    rdfs:comment "The accepted version of a publishable document."@en .
#+end_src

** ppo:submittedVersion                                                 :individual:

#+begin_src ttl
ppo:submittedVersion a ppo:documentVersion ;
    rdfs:label "Submitted version"@en ;
    rdfs:comment "The submitted version of a publishable document."@en .
#+end_src
...
** ppo:hasWikidataId                                                      :property:

#+begin_src ttl
ppo:hasWikidataId a rdf:Property ;
    rdfs:subPropertyOf dcterms:identifier ;
    rdfs:domain ppo:Platform ;
    rdfs:range xsd:anyURI ;
    rdfs:label ""@en ;
