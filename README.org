...
[[file:docs/img/job_prototype-PAD_Service.drawio.png]]
...
APP_SPARQL_HOST="http://localhost:7200"
...
docker run -d \
    ...
    --env "APP_SPARQL_HOST=${APP_SPARQL_HOST}" \
    --env "APP_SPARQL_QUERY_PATH=${APP_SPARQL_QUERY_PATH}" \
    --env "APP_SPARQL_UPDATE_PATH=${APP_SPARQL_UPDATE_PATH}" \
